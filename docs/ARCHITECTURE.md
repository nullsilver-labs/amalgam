...
1. Strengthen daily chat: provider-specific token budgets, native OpenAI Responses/Gemini, editable/regenerable branches, full archive pagination, better connection setup.
